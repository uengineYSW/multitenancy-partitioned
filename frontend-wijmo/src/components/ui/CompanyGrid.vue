<template>
    <div style="max-height:80vh;">
        ...
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
            ...
            <v-btn @click="updateCompanyDialog = true" class="contrast-primary-text" small color="primary" :disabled="!hasRole('Admin')">
                <v-icon small>mdi-minus-circle-outline</v-icon>회사 업데이트
            </v-btn>
            <v-dialog v-model="updateCompanyDialog" width="500">
                <UpdateCompanyCommand
                    @closeDialog="updateCompanyDialog = false"
...
<script>
import CompanyQuery from '../CompanyQueryView.vue';
    ...
    methods:{
        updateCompany(params){
            try{
                ...
                this.$EventBus.$emit('show-success','UpdateCompany 성공적으로 처리되었습니다.')
            }catch(e){
